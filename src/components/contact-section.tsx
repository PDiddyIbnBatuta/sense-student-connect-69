      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-elegant border-border/50 hover:shadow-glow transition-all duration-500 transform hover:-translate-y-2 animate-fade-in">
          <CardContent className="p-8 sm:p-12 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-primary mb-8 animate-slide-up">
              Get in Touch
            </h2>
            <div className="flex items-center justify-center gap-4 text-lg animate-scale-in">
